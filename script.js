...
var markerKantor = L.marker([-7.8184308552018535, 112.00956899535286], {icon: kantorIcon}).addTo(map);
...
var markerGerejaBethany = L.marker([-7.818141477013701, 112.00936904771905], {icon: gerejaIcon}).addTo(map);
...
var markerGerejaPRII = L.marker([-7.8160058923517415, 112.00891575272055], {icon: gerejaIcon}).addTo(map);
markerGerejaPRII.bindPopup("<b>Gereja Reformed Injili Indonesia PRII Kediri</b>");

// Marker GPdl FILADELFIA Kediri Kota
var markerGerejaFILADELFIA = L.marker([-7.818124753896681, 112.01087353370222], {icon: gerejaIcon}).addTo(map);
markerGerejaFILADELFIA.bindPopup("<b>GPdl FILADELFIA Kediri Kota</b>");

// Marker Vihara Metta Maitreya
var markerViharaMettaMaitreya = L.marker([-7.817363176848054, 112.00899966316895], {icon: viharaIcon}).addTo(map);
markerViharaMettaMaitreya.bindPopup("<b>Vihara Metta Maitreya</b>");

// Marker Susteran Putri Kasih
var markerSusteranPutriKasih = L.marker([-7.813714395469712, 112.01022930853844], {icon: gerejaIcon}).addTo(map);
markerSusteranPutriKasih.bindPopup("<b>Susteran Putri Kasih</b>");

// Marker Gie Kie Kong Soe
var markerGieKieKongSoe = L.marker([-7.817650780702965, 112.01115682573888], {icon: gieIcon}).addTo(map);
markerGieKieKongSoe.bindPopup("<b>Gie Kie Kong Soe</b>");

// Marker Punden Pakelan
var markerPundenPakelan = L.marker([-7.8161937913280415, 112.01017182125483], {icon: pundenIcon}).addTo(map);
markerPundenPakelan.bindPopup("<b>Punden Pakelan</b>");

// Marker Masjid Al-Hidayah
var markerMasjidAlHidayah = L.marker([-7.816128419877064, 112.01015643248117], {icon: masjidIcon}).addTo(map);
markerMasjidAlHidayah.bindPopup("<b>Masjid Al-Hidayah</b>");

// Marker Koramil 0809/01 Kota Kediri
var markerKoramil = L.marker([-7.819478296348127, 112.01094422339499], {icon: koramilIcon}).addTo(map);

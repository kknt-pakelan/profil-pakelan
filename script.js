...
var markerKantor = L.marker([-7.8184308552018535, 112.00956899535286]).addTo(map);
...
var markerKelenteng = L.marker([-7.819991724537468, 112.00959693836458]).addTo(map);
markerKelenteng.bindPopup("<b>Kelenteng Tjoe Hwie Kiong</b><br>Ikon Wisata Heritage.");

// Marker Gereja Pusat Pantekosta Indonesia
var markerGerejaPusat = L.marker([-7.814269955615778, 112.01172826582454]).addTo(map);
...
var markerGerejaBethany = L.marker([-7.818141477013701, 112.00936904771905]).addTo(map);
...
var markerGerejaPRII = L.marker([-7.8160058923517415, 112.00891575272055]).addTo(map);
markerGerejaPRII.bindPopup("<b>Gereja Reformed Injili Indonesia PRII Kediri</b>");

// Marker GPdl FILADELFIA Kediri Kota
var markerGerejaFILADELFIA = L.marker([-7.818124753896681, 112.01087353370222]).addTo(map);
markerGerejaFILADELFIA.bindPopup("<b>GPdlFILADELFIA Kediri Kota</b>");

// Marker Vihara Metta Maitreya
var markerViharaMettaMaitreya = L.marker([-7.817363176848054, 112.00899966316895]).addTo(map);
markerViharaMettaMaitreya.bindPopup("<b>Vihara Metta Maitreya</b>");

// Marker Susteran Putri Kasih
var markerSusteranPutriKasih = L.marker([-7.813714395469712, 112.01022930853844]).addTo(map);
markerSusteranPutriKasih.bindPopup("<b>Susteran Putri Kasih</b>");

// Marker Gie Kie Kong Soe
var markerGieKieKongSoe = L.marker([-7.817650780702965, 112.01115682573888]).addTo(map);
markerGieKieKongSoe.bindPopup("<b>Gie Kie Kong Soe</b>");

// Marker Masjid Al-Hidayah
var markerMasjidAlHidayah = L.marker([-7.816128419877064, 112.01015643248117]).addTo(map);
markerMasjidAlHidayah.bindPopup("<b>Masjid Al-Hidayah</b>");

// Marker Punden Pakelan
var markerPundenPakelan = L.marker([-7.8161937913280415, 112.01017182125483]).addTo(map);
markerPundenPakelan.bindPopup("<b>Punden Pakelan</b>");

// Marker Koramil 0809/01 Kota Kediri
var markerKoramil = L.marker([-7.819478296348127, 112.01094422339499]).addTo(map);
markerKoramil.bindPopup("<b>Koramil 0809/01 Kota Kediri</b>");
